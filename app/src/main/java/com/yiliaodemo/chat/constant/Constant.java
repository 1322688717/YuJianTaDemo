...
public class Constant {
    ...
    //腾讯云
    //腾讯云 cos 服务的 app id
    public static final String TENCENT_CLOUD_APP_ID = "1258784792";
    //对应的 秘钥ID
    public static final String TENCENT_CLOUD_SECRET_ID = "AKIDf9PRFpAIH2auzXszsb5TeeT5UghV7Wkl";
    // 对应的 秘钥
    public static final String TENCENT_CLOUD_SECRET_KEY = "ub5NXXL2Zv54tXzGQPC1iIjy2wdCaUDr";
    // bucketForObjectAPITest 所处在的地域
    public static final String TENCENT_CLOUD_REGION = "南京 （中国）（ap-nanjing）";
    //存储桶
    public static final String TENCENT_CLOUD_BUCKET = "yujianta-1258784792";
    ...
    //腾讯IM
    public static final int TIM_APP_ID = 1400746829;
